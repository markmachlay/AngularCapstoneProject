...
//                optionsBuilder.UseSqlServer("Server=(LocalDb)\\localhost;Database=Angular;Trusted_Connection=true;MultipleActiveResultSets=true");
//            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Favorite>(entity =>
            {
                ...
                entity.HasOne(d => d.Event)
                    ...
                    .HasConstraintName("FK__Favorites__Event__276EDEB3");
            });
